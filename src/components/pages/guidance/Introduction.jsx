          ...
          <Row>
            <div className="column small-12 large-10 large-offset-1">
              ...
              <div className="text-container">
                ...
                <p className="text">Nature-based solutions can help mitigate flood (the focus of this document), drought, erosion and landslide.</p>
