            ...
            <div className="column small-12 medium-3">
              <div id="fixedMenu" className="fixed-menu">
                ...
                <ul className="menu-list">
                  <li id="anc1"><a className="js-scroll-imp1" href="#implementation1">01. Define problem, project scope and objectives</a></li>
