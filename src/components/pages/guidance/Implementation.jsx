          ...
          <Row>
            ...
            <div id="implementations" className="column small-12 medium-9">
              ...
              <section id="implementation3">
                ...
                <h2 className="section-title">Implementation 3</h2>
                <p className="text"></p>
              ...
              <section id="implementation4">
                ...
                <h2 className="section-title">Implementation 4</h2>
                <p className="text"></p>
              ...
              <section id="implementation5">
                ...
                <h2 className="section-title">Implementation 5</h2>
                <p className="text"></p>

                <h3 className="info-title -secondary"></h3>
                <p className="text"></p>
