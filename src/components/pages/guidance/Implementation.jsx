            ...
            <div id="implementations" className="column small-12 medium-9">
              ...
              <section id="implementation5">
                ...
                <article className="extra-info">
                  ...
                  <h3 className="info-title">Read more</h3>
                  <p className="text">Vojinovic, Zoran, et al. "Combining Ecosystem Services with Cost-Benefit Analysis for Selection of Green and Grey Infrastructure for Flood Protection in a Cultural Setting." Environments 4.1 (2016). <a href="http://www.mdpi.com/2076-3298/4/1/3">http://www.mdpi.com/2076-3298/4/1/3</a></p>
